...
public class DefDocItemCG implements Serializable {
	...
	public String getInorderdocshowid() {
		return inorderdocshowid;
	}

	public void setInorderdocshowid(String inorderdocshowid) {
		this.inorderdocshowid = inorderdocshowid;
	}
	...
	public DefDocItemCG(DefDocItemCG cg) {
	...
	public String toString() {
		return "DefDocItemCG [barcode=" + barcode + ", bignum=" + bignum + ", costprice=" + costprice
				+ ", discountprice=" + discountprice + ", subtotal=" + subtotal + ", discountsubtotal="
				+ discountsubtotal + ", goodsid=" + goodsid + ", goodsname=" + goodsname + ", warehouseid="
				+ warehouseid + ", warehousename=" + warehousename + ", unitid=" + unitid + ", unitname=" + unitname
				+ ", isgift=" + isgift + ", num=" + num + ", price=" + price + ", discountratio=" + discountratio
				+ ", specification=" + specification + ", remark=" + remark + ", isusebatch=" + isusebatch
				+ ", isdiscount=" + isdiscount + ", batch=" + batch + ", rversion=" + rversion + ", itemid=" + itemid
				+ ", tempitemid=" + tempitemid + ", docid=" + docid + "]";
	}
